...
function Profile() {
    ...
    useEffect(() => {
        //header text
        gsap.to(g("header p"), 1, { text: "Anthony's portfolio ", repeat: -1, yoyo: true, repeatDelay: 1 });

        //hero text animation
        gsap.to(g("#right > p"), 1.5, { text: "Welcome to my world", repeat: -1, yoyo: true, repeatDelay: 1 });

        //arrow
        gsap.from(g("#summaryarrow"), { y: -20, repeat: -1, duration: 1.2, ease: Power4.easeInOut });
        gsap.from(g("#arrow"), { y: -20, repeat: -1, duration: 1.2, ease: Power4.easeInOut });
    ...
    /*     useEffect(() => {
        gsap.to(g("header p"), 1, { text: "Anthony Ezeh", yoyo: true, repeat: -1, delay: 1, repeatDelay: 1 });

        gsap.from(g(".profile #arrow"), { y: -20, repeat: -1, duration: 1.2, ease: Power4.easeInOut });

        gsap.from(g("#summaryarrow"), 1.2, { y: -20, repeat: -1, ease: Power4.easeInOut });
        gsap.to(g("header"), {
            position: "fixed",
    ...
    return (
        <div className={styles.profile} ref={ref}>
            ...
            <div id="summary" className={styles.summary}>
                <img id="summaryarrow" className={styles.arrow} src="/down.svg" alt="" />
                <h1 className="summaryh">Summary</h1>
                <p>
                    I’m a <span>front-end</span> web developer with a few years of experience. I have acquired
                    experience that has improved my productivity in the long run, having worked on personal projects and
                    with friends. This has also impacted on my skills, problem solving ability, communication ability,
                    and ability to carry out research pertaining to what is required for a job. It is an art to me, I
                    love what I do and I really admire the process to completion; it is addictive. When I'm not working
                    alongside clients, I enjoy and spend time creating personal projects.
                </p>
            </div>
            ...
            <div id="projects" className={styles.projects}>
                '<h1>Projects</h1>
                <ul>
                    <Link href="https://droplike.vercel.app/">
                        <div>
                            <img src="/droplike.png" alt="" /> <p>Droplike</p>
                        </div>
                    </Link>
                    ...
                    <Link href="https://jotter-zeta.vercel.app/">
                        <div>
                    ...
                    <div className={styles.screen}>
                        <form>
                            ...
                            <main>
                                ...
                                >
                                    {!loading && "Send"}
                                    <ClapSpinner size={18} frontColor={"#f3eade"} loading={loading} />
                                </button>
                            </main>
                        </form>
                    </div>
